    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 px-4 pt-8 pb-6 space-y-2 overflow-y-auto">
            ...
            <a href="<?= baseUrl('pages/transactions.php') ?>" 
               class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 <?= ($currentPage == 'transactions.php' || $currentPage == 'transaction-detail.php') ? 'bg-primary-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?= baseUrl('pages/payment-methods.php') ?>" 
               class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 <?= ($currentPage == 'payment-methods.php') ? 'bg-primary-600 text-white shadow-md' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
